...
class Ui_Mainpage(object):
    def setupUi(self, Mainpage):
        ...
        self.Screen.setStyleSheet("border-radius: 25px;  border: 10px groove gray;\n"
"border-style: outset;\n"
"border-color: rgb(2, 158, 255);")
        self.Screen.setFrameShape(QtWidgets.QFrame.Box)
        self.Screen.setLineWidth(3)
        self.Screen.setObjectName("Screen")
        self.ScreenPic = QtWidgets.QLabel(self.Screen)
        self.ScreenPic.setGeometry(QtCore.QRect(3, 3, 1280, 720))
        self.ScreenPic.setMinimumSize(QtCore.QSize(1280, 720))
        self.ScreenPic.setMaximumSize(QtCore.QSize(1280, 720))
        self.ScreenPic.setBaseSize(QtCore.QSize(1280, 720))
...
"background-color: rgb(255, 0, 0);")
        ...
        self.SmallDebugWin = QtWidgets.QLabel(self.DebugMessageBox)
        self.SmallDebugWin.setGeometry(QtCore.QRect(120, 10, 1000, 60))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SmallDebugWin.sizePolicy().hasHeightForWidth())
        self.SmallDebugWin.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.A1.setMaximum(255)
        self.A1.setProperty("value", 128)
        ...
        self.A2.setMaximum(255)
        self.A2.setProperty("value", 128)
        ...
        self.A3.setMinimum(0)
        self.A3.setMaximum(255)
        self.A3.setProperty("value", 128)
        self.A3.setSliderPosition(128)
...
"")
        ...
        self.PowerNum = QtWidgets.QLabel(self.Tab)
        self.PowerNum.setGeometry(QtCore.QRect(220, 60, 101, 40))
        font = QtGui.QFont()
        font.setFamily("Microsoft JhengHei UI")
        font.setPointSize(27)
        font.setBold(True)
        font.setWeight(75)
        self.PowerNum.setFont(font)
        self.PowerNum.setStyleSheet("color: rgb(89, 122, 180);")
        self.PowerNum.setAlignment(QtCore.Qt.AlignCenter)
        self.PowerNum.setObjectName("PowerNum")
        self.Auto.raise_()
        self.Power.raise_()
...
"Window"))
        ...
        self.PowerNum.setText(_translate("Mainpage", "12.2V"))
import resource_rc
